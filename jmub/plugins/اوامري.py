...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر ادلوف
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmub.uid:
            buttons = [
                [Button.inline("معلومات ادلوف", data="AOMRDB")],
                [
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس ادلوف هذه بعض المعلومات عن ادلوف:

- سورس ادلوف يمتلك اكثر من 100 أمر 
- ادلوف هو افضل سورس عربي يتميز بالحماية
