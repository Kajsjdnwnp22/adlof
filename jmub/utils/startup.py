...
LOGS = logging.getLogger("اعداد ادلوف")
...
async def saves():
    try:
        ...
        print(str(e))
    try:
        await jmub(UnblockRequest("@KO_CG"))
        await jmub(UnblockRequest("KO_CG"))
        await jmub(
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_file(
                    BOTLOG_CHATID,
                    "https://telegra.ph/file/ec10161d98c63ab1f4518.jpg",
                    caption="**شكرا لتنصيبك سورس ادلوف**\n • هنا بعض الملاحظات التي يجب ان تعرفها عن استخدامك لسورس ادلوف.",
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_message(
                    BOTLOG_CHATID,
                    "**لقد تم بنجاح تنصيب سورس ادلوف **\n➖➖➖➖➖➖➖➖➖➖\n**السورس**: @KO_CG\n**المطور**:@FFFDFN \n➖➖➖➖➖➖➖➖➖➖\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        (Button.url("كروب المساعدة", "https://t.me/"),)
                    ],
                )
        except Exception as e:
            LOGS.error(e)
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كروب بوت ادلوف", jmub, Config.TG_BOT_USERNAME, descript, photobt
        )
